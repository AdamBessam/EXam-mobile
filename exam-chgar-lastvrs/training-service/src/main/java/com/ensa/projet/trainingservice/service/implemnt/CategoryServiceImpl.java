...
public class CategoryServiceImpl implements CategoryService {
    ...
    public CategoryDTO createCategory(CategoryDTO categoryDTO) {
        ...
        if (categoryDTO.getIcon() != null) {
            String iconPath = fileStorageService.storeFile(categoryDTO.getIcon());
    ...
    public CategoryDTO updateCategory(Integer id, CategoryDTO categoryDTO) {
        ...
        if (categoryDTO.getIcon() != null) {
            ...
            if (category.getIconPath() != null) {
                fileStorageService.deleteFile(category.getIconPath());
            }
            String iconPath = fileStorageService.storeFile(categoryDTO.getIcon());
            category.setIconPath(iconPath);
        }
    ...
    public void deleteCategory(Integer id) {
        ...
        // Suppression de l'icône si elle existe
        if (category.getIconPath() != null) {
            fileStorageService.deleteFile(category.getIconPath());
        }
